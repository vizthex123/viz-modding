# Adds Obscuria's Tooltips support to various items

print("tooltips_ob.zs loading...");
/*
tag:items:forge:tooltips/custom - required on everything

damage - attack dmg
durability
souls - durability, but with a soul icon
armor - armour value
energy - RF value
*/
...
# Malum
<tag:items:forge:tooltips/custom>.add(<item:malum:crude_scythe>);
<tag:items:forge:tooltips/damage>.add(<item:malum:crude_scythe>);
<tag:items:forge:tooltips/durability>.add(<item:malum:crude_scythe>);

<tag:items:forge:tooltips/custom>.add(<item:malum:soul_stained_steel_scythe>);
<tag:items:forge:tooltips/damage>.add(<item:malum:soul_stained_steel_scythe>);
<tag:items:forge:tooltips/durability>.add(<item:malum:soul_stained_steel_scythe>);
