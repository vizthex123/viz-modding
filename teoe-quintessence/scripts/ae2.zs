...
# Each one is 1.5k Essenarium, a platinum ingot, sky stone block, and 2 of its used material combination crafted into an Iron Block
# RF cost is based on how advanced each processor is
mods.extendedcrafting.CombinationCrafting.addRecipe("silicon_press", <item:ae2:silicon_press>, 8000, [<item:minecraft:iron_block>, <item:ae2:sky_stone_block>|<item:ae2:smooth_sky_stone_block>, <item:ob_core:platinum_ingot>, <tag:items:forge:silicon>, <tag:items:forge:silicon>, <item:lightmanscurrency:coin_emerald>, <item:lightmanscurrency:coin_gold>], 80);

mods.extendedcrafting.CombinationCrafting.addRecipe("logic_press", <item:ae2:logic_processor_press>, 16000, [<item:minecraft:iron_block>, <item:ae2:sky_stone_block>|<item:ae2:smooth_sky_stone_block>, <item:ob_core:platinum_ingot>, <item:minecraft:gold_ingot>, <item:minecraft:gold_ingot>, <item:lightmanscurrency:coin_emerald>, <item:lightmanscurrency:coin_gold>], 160);

mods.extendedcrafting.CombinationCrafting.addRecipe("calculation_press", <item:ae2:calculation_processor_press>, 24000, [<item:minecraft:iron_block>, <item:ae2:sky_stone_block>|<item:ae2:smooth_sky_stone_block>, <item:ob_core:platinum_ingot>, <item:ae2:certus_quartz_crystal>, <item:ae2:certus_quartz_crystal>, <item:lightmanscurrency:coin_emerald>, <item:lightmanscurrency:coin_gold>], 240);

mods.extendedcrafting.CombinationCrafting.addRecipe("engineering_press", <item:ae2:engineering_processor_press>, 32000, [<item:minecraft:iron_block>, <item:ae2:sky_stone_block>|<item:ae2:smooth_sky_stone_block>, <item:ob_core:platinum_ingot>, <item:minecraft:diamond>, <item:minecraft:diamond>, <item:lightmanscurrency:coin_emerald>, <item:lightmanscurrency:coin_gold>], 320);
