...
<tag:items:teoe:meltable_copper>.add(<item:additionaladditions:depth_meter>);
<tag:items:teoe:meltable_copper>.add(<item:additionaladditions:watering_can>);
<tag:items:teoe:meltable_copper>.add(<item:additionaladditions:wrench>);
...
# Iron
<tag:items:teoe:meltable_metal>.add(<item:minecraft:chainmail_helmet>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:chainmail_chestplate>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:chainmail_leggings>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:chainmail_boots>);

<tag:items:teoe:meltable_metal>.add(<item:minecraft:iron_helmet>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:iron_chestplate>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:iron_leggings>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:iron_boots>);

<tag:items:teoe:meltable_metal>.add(<item:minecraft:iron_sword>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:iron_pickaxe>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:iron_axe>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:iron_shovel>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:iron_hoe>);

<tag:items:teoe:meltable_metal>.add(<item:minecraft:iron_horse_armor>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:flint_and_steel>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:crossbow>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:shears>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:shield>);

#	<tag:items:teoe:meltable_metal>.add(<item:vanillatweaks:slime_bucket>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:bucket>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:cauldron>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:chain>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:compass>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:heavy_weighted_pressure_plate>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:hopper>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:iron_bars>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:iron_door>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:iron_trapdoor>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:lantern>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:soul_lantern>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:stonecutter>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:tripwire_hook>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:minecart>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:activator_rail>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:detector_rail>);
<tag:items:teoe:meltable_metal>.add(<item:minecraft:rail>);

<tag:items:teoe:meltable_metal>.add(<item:botania:ghost_rail>);
<tag:items:teoe:meltable_metal>.add(<item:thermal:crossover_rail>);


<tag:items:teoe:meltable_metal>.add(<item:aquamirae:terrible_helmet>);
<tag:items:teoe:meltable_metal>.add(<item:aquamirae:terrible_chestplate>);
<tag:items:teoe:meltable_metal>.add(<item:aquamirae:terrible_leggings>);
<tag:items:teoe:meltable_metal>.add(<item:aquamirae:terrible_boots>);

<tag:items:teoe:meltable_metal>.add(<item:aquamirae:terrible_sword>);
<tag:items:teoe:meltable_metal>.add(<item:aquamirae:poisoned_blade>);
<tag:items:teoe:meltable_metal>.add(<item:aquamirae:oxygen_tank>);

<tag:items:teoe:meltable_metal>.add(<item:byg:boric_lantern>);
<tag:items:teoe:meltable_metal>.add(<item:byg:glowstone_lantern>);
<tag:items:teoe:meltable_metal>.add(<item:byg:therium_lantern>);
<tag:items:teoe:meltable_metal>.add(<item:byg:cryptic_lantern>);
<tag:items:teoe:meltable_metal>.add(<item:byg:chain_plating>);

<tag:items:teoe:meltable_metal>.add(<item:cookingforblockheads:fridge>);
<tag:items:teoe:meltable_metal>.add(<item:cookingforblockheads:oven>);
<tag:items:teoe:meltable_metal>.add(<item:cookingforblockheads:toaster>);

<tag:items:teoe:meltable_metal>.add(<item:create:chute>);
<tag:items:teoe:meltable_metal>.add(<item:create:filter>);
<tag:items:teoe:meltable_metal>.add(<item:create:super_glue>);
<tag:items:teoe:meltable_metal>.add(<item:create:metal_bracket>);

<tag:items:teoe:meltable_metal>.add(<item:enigmaticlegacy:iron_ring>);

<tag:items:teoe:meltable_metal>.add(<item:essentials:item_chute>);

<tag:items:teoe:meltable_metal>.add(<item:fuel_canister:fuel_canister>);

<tag:items:teoe:meltable_metal>.add(<item:quark:iron_button>);
<tag:items:teoe:meltable_metal>.add(<item:quark:iron_ladder>);
<tag:items:teoe:meltable_metal>.add(<item:quark:trowel>);

<tag:items:teoe:meltable_metal>.add(<item:thermal:drill_head>);
<tag:items:teoe:meltable_metal>.add(<item:thermal:saw_blade>);
<tag:items:teoe:meltable_metal>.add(<item:thermal:slot_seal>);
<tag:items:teoe:meltable_metal>.add(<item:thermal:prismarine_activator_rail>);
<tag:items:teoe:meltable_metal>.add(<item:thermal:prismarine_crossover_rail>);
<tag:items:teoe:meltable_metal>.add(<item:thermal:prismarine_detector_rail>);
<tag:items:teoe:meltable_metal>.add(<item:thermal:prismarine_rail>);

<tag:items:teoe:meltable_metal>.add(<tag:items:whisperwoods:wisp_lantern>);


// These items melt into a nugget since they use 3 or less per craft
<tag:items:teoe:meltable_metal_small>.add(<item:createaddition:spool>);
<tag:items:teoe:meltable_metal_small>.add(<item:cookingforblockheads:tool_rack>);
<tag:items:teoe:meltable_metal_small>.add(<item:ironjetpacks:strap>);
<tag:items:teoe:meltable_metal_small>.add(<item:twilightforest:iron_ladder>);

// Melts into regular Scrap since they use 9 ingots or more
<tag:items:teoe:meltable_metal_big>.add(<item:minecraft:anvil>);
<tag:items:teoe:meltable_metal_big>.add(<item:minecraft:chipped_anvil>);
<tag:items:teoe:meltable_metal_big>.add(<item:minecraft:damaged_anvil>);
<tag:items:teoe:meltable_metal_big>.add(<item:aquamirae:three_bolt_helmet>);
<tag:items:teoe:meltable_metal_big>.add(<item:aquamirae:three_bolt_suit>);
<tag:items:teoe:meltable_metal_big>.add(<item:aquamirae:three_bolt_leggings>);
<tag:items:teoe:meltable_metal_big>.add(<item:aquamirae:three_bolt_boots>);
<tag:items:teoe:meltable_metal_big>.add(<item:create:mechanical_press>);
<tag:items:teoe:meltable_metal_big>.add(<item:create:schematicannon>);
<tag:items:teoe:meltable_metal_big>.add(<item:xnet:antenna_base>);
...
<tag:items:teoe:meltable_gold>.add(<item:enigmaticlegacy:gem_ring>);
