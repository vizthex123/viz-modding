...
furnace.addRecipe("fungus_cyan", cyan, <item:minecraft:warped_fungus>, 0.1, 200);
...
furnace.addRecipe("dripleaf_green", green, <item:minecraft:small_dripleaf>|<item:minecraft:big_dripleaf>, 0.1, 200);
...
furnace.addRecipe("fungus_red", red, <item:minecraft:crimson_fungus>, 0.1, 200);
