...
smoker.addRecipe("flesh_to_leather", <item:minecraft:leather>, <item:minecraft:rotten_flesh>, 1.0, 10);

// Blast Furnace glass
blastFurnace.addRecipe("sand_to_glass", <item:minecraft:glass>, <tag:items:minecraft:sand>, 0.1, 5);
*/
