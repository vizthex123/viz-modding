...
<recipetype:thermal:smelter>.addRecipe("black_dye", [<item:minecraft:black_dye> % 100, <item:minecraft:black_dye> % 50], [<item:minecraft:coal>*4, <item:minecraft:charcoal>*4], 0, 6000);

<recipetype:thermal:smelter>.addRecipe("black_dye_block", [<item:minecraft:black_dye>*3 % 100, <item:minecraft:black_dye> % 50, <item:minecraft:black_dye> % 50], [<item:minecraft:coal_block>|<item:thermal:charcoal_block>, <tag:items:forge:dyes>, <tag:items:forge:dyes>], 0, 8000);
