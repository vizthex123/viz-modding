...
craftingTable.addShapeless("iron_scrap", <item:kubejs:scrap>, [<item:kubejs:small_iron_scrap>, <item:kubejs:small_iron_scrap>, <item:kubejs:small_iron_scrap>]);
...
furnace.addRecipe("smelt_iron_scrap", <item:minecraft:iron_ingot>, <item:kubejs:iron_scrap>, 0, 200);
...
blastFurnace.addRecipe("blast_iron_scrap", <item:minecraft:iron_ingot>, <item:kubejs:iron_scrap>, 0, 100);
