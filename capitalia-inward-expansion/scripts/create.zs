...
<recipetype:create:crushing>.addRecipe("crush_raw_zinc", [<item:create:crushed_raw_zinc>, xp % 75], <item:bluepower:zinc_raw>);
...
// Concrete
<recipetype:create:milling>.addRecipe("mill_concrete", [<item:minecraft:sand> % 50, dust % 50], <tag:items:minecraft:concrete>, 200);
