# Adds items to Randomium Ore

print("randomium.zs loading...");
...
<tag:items:randomium:whitelist>.add(<item:minecraft:iron_nugget>);
<tag:items:randomium:whitelist>.add(<item:minecraft:gold_nugget>);
<tag:items:randomium:whitelist>.add(<item:create:copper_nugget>);
<tag:items:randomium:whitelist>.add(<item:create:zinc_nugget>);
