...
ResearchTable.builder("ap_ammo", ammo)
  ...
  .setRewardCommands("/say You can now craft Armour Piercing rounds")
...
ResearchTable.builder("ap_ammo_2", ammo)
  ...
  .setRewardCommands("/say You can now craft Armour Piercing shells")
...
ResearchTable.builder("advanced_ammo", ammo)
  ...
  .setRewardCommands("/say You can now craft Lumium Rounds")
...
ResearchTable.builder("advanced_ammo_2", ammo)
  ...
  .setRewardCommands("/say You can now craft Lumium Shells")
