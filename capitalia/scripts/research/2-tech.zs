...
ResearchTable.builder("advanced_circuitry", tech)
  ...
  .setDescription("Research how to create more advanced circuitry. This allows you to create more advanced machinery, and is the basis of space travel.")
...
ResearchTable.builder("oil", tech)
  ...
  .addCondition(<liquid:liquid_research>*500)
  .setRewardStages("oil")
...
ResearchTable.builder("wireless_power", tech)
  ...
  .addCondition(<liquid:liquid_research>*1000)
...
ResearchTable.builder("basic_reactor", tech)
  ...
  .setDescription("Research ways to utilize yellorium to create energy, using atomic fission.")
  .addCondition(<contenttweaker:datadisk_machine>*4)
  .addCondition(<contenttweaker:datadisk_industrial>*8)
  .addCondition(<liquid:liquid_research>*2000)
...
ResearchTable.builder("ae2", tech)
  ...
  .setDescription("Research more efficient ways to compress, transmit, and store data; as well as automate crafting using advanced matter-energy conversion technology.")
  .addCondition(<contenttweaker:datadisk_information>*4)
  .addCondition(<contenttweaker:datadisk_machine>*6)
  .addCondition(<contenttweaker:datadisk_industrial>*8)
  .setRewardStages("ae2")
  .setRewardCommands("/say You've improved upon your discovery of matter-energy conversion.")
#  .setRewardItems(<minecraft:experience_bottle>*16, <refinedstorage:storage_disk>*2)
