...
mods.jei.JEI.addDescription(<item:ae2:me_p2p_tunnel>, ["Right-click with an accepted item to change it to that type of P2P tunel" + "Filter JEI with $attunment to see the accepted list (it uses item tags)"]);
