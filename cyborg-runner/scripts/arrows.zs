...
recipes.addShapedMirrored(<simplyarrows:arrow_bone>*2, [[null, <minecraft:bone>, null],
...
recipes.addShapeless(<simplyarrows:arrow_torch>, [<minecraft:arrow>|<simplyarrows:arrow_flint>, <bonetorch:bonetorch>|<minecraft:torch>]);
<simplyarrows:arrow_torch>.addTooltip(format.yellow("Places a torch wherever it lands"));

recipes.addShapeless(<simplyarrows:arrow_tnt>, [<minecraft:tnt>, <minecraft:arrow>|<simplyarrows:arrow_bone>|<simplyarrows:arrow_flint>|<simplyarrows:arrow_iron>]);
